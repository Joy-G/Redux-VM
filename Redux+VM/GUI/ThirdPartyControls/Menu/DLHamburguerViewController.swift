    ...
    var contentViewController: UIViewController! {
        ...
        set {
            ...
            if newValue != nil {
                ...
                newValue.view.topAnchor.constraint(equalTo: view.topAnchor, constant: 0).isActive = true
                newValue.view.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: 0).isActive = true
                newValue.view.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 0).isActive = true
                newValue.view.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: 0).isActive = true
